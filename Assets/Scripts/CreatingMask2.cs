...
using System.IO;
using System.Linq;
public class CreatingMask2 : MonoBehaviour
{
   public  AnimationCurve animationCurve;
    ...
    public bool findMuzzel = false;
    public bool findLazer = false;

    public int umbral;
    public int iterations;

    int umbralSum= 200000;
    ...
    private void Start()
    {
        ...
        if (cameraEnabled)
        {
           ...
           image.texture = webCamTexture;
            ...
            mat = OpenCvSharp.Unity.TextureToMat(texture);
            Cv2.CvtColor(mat, mat, ColorConversionCodes.BGR2Lab);

            //image.texture = OpenCvSharp.Unity.MatToTexture(mat.ExtractChannel(1));
            if (findMuzzel)
    ...
    void FindMuzzel(Mat m)
    {
        ...
        Cv2.Threshold(m, m, 111, 255, ThresholdTypes.BinaryInv);//ideal ->180
